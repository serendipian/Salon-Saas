  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
      ...
      <div className="bg-slate-50 border-b border-slate-200 p-3 flex flex-wrap gap-2 items-center justify-between">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="text-xs flex items-center gap-1.5 text-slate-600 hover:text-slate-900 font-medium bg-white border border-slate-200 hover:border-slate-300 px-3 py-1.5 rounded-lg transition-all shadow-sm"
          ...
          <button 
            ...
            className="text-xs flex items-center gap-1.5 text-brand-600 hover:text-brand-700 font-medium bg-brand-50 hover:bg-brand-100 border border-brand-100 px-3 py-1.5 rounded-lg transition-all"
      ...
      <div className="grid grid-cols-12 gap-4 p-3 bg-slate-50/50 border-b border-slate-200 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
        ...
        <div className="col-span-6">Plage Horaire</div>
      </div>
            ...
            >
                  ...
                  >
                    <span
                      className={`
                        ...
                        ${isOpen ? 'opacity-0 duration-100 ease-out' : 'opacity-100 duration-200 ease-in'}
                      `}
                      aria-hidden="true"
                    >
                    ...
                    <span
                      className={`
                        absolute inset-0 flex h-full w-full items-center justify-center transition-opacity
                        ${isOpen ? 'opacity-100 duration-200 ease-in' : 'opacity-0 duration-100 ease-out'}
                      `}
                      aria-hidden="true"
                    >
              ...
              <div className="col-span-6">
                {isOpen ? (
                  <div className="flex items-center gap-2 animate-in fade-in slide-in-from-left-2 duration-300">
                    <div className="relative flex-1">
                      ...
                      <input 
                        ...
                        className="block w-full pl-8 pr-2 py-1.5 text-sm text-center bg-white border border-slate-300 rounded-lg focus:ring-1 focus:ring-slate-900 focus:border-slate-900 shadow-sm hover:border-slate-400 transition-colors"
                      />
                    </div>
                  ...
                  <div className="w-full flex justify-center items-center h-[38px] animate-in zoom-in-95 duration-200">
