...
import { RecurringExpense, ExpenseCategorySetting } from '../types';
             ...
             <div className="max-w-xl space-y-8 animate-in fade-in">
               <div>
                 ...
                 <div className="grid grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-1.5">Taux de TVA (%)</label>
                      <div className="relative">
                         <input type="number" defaultValue={20} className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm bg-white" />
              ...
              <div className="max-w-xl space-y-6 animate-in fade-in">
                ...
                <div className="flex gap-2 mb-6">
                  <input 
                    ...
                    className="flex-1 px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-900 outline-none bg-white"
                  />
                  <button 
                ...
                {isAddingRec && (
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-6 animate-in slide-in-from-top-2">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                       ...
                       <div>
                         <label className="text-xs font-medium text-slate-500 mb-1 block">Montant (€)</label>
                         <input 
                           type="number"
                       ...
                       <div>
                         ...
                         <select 
                           ...
                           onChange={e => setNewRecExpense({...newRecExpense, frequency: e.target.value as any})}
