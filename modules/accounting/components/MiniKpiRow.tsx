...
export const TrendBadge: React.FC<{ trend: number; invertTrend?: boolean }> = ({
  trend,
  invertTrend,
}) => {
  if (trend === 0) {
  ...
  return (
    <span
      className={`text-[11px] font-medium px-1.5 py-0.5 rounded flex items-center gap-0.5 ${
...
export const KpiCard: React.FC<KpiItem> = ({
  title,
  value,
  format,
  trend,
