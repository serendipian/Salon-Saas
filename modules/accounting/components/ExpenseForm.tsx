...
const getCategoryIcon = (name: string) => CATEGORY_ICONS[name.toLowerCase()] || <Tag size={14} />;
              ...
              <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800 animate-in fade-in">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600 mt-0.5">
                    Une dépense similaire existe déjà : « {possibleDuplicate.description} » —{' '}
                    {possibleDuplicate.amount.toFixed(2)} {currencySymbol} le{' '}
                    {new Date(possibleDuplicate.date).toLocaleDateString()}
                  </p>
                </div>
              </div>
            )}
            ...
            {formData.proofUrl ? (
              <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-xl border border-emerald-200">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className="text-sm font-medium text-emerald-800 truncate">
                      {uploadedFileName || 'Justificatif ajouté'}
                    </p>
                  </div>
                  <a
                ...
                <button
                  type="button"
                  onClick={() => {
                    setFormData({ ...formData, proofUrl: undefined });
              ...
              <label
                className={`flex flex-col items-center gap-2 p-6 border-2 border-dashed rounded-xl transition-all ${
                  isUploading
                ...
                {isUploading ? (
                  ...
                  <>
                    ...
                    <span className="text-sm text-slate-500">
                      Glissez ou cliquez pour ajouter un justificatif
                    </span>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Section title="Catégorie & Bénéficiaire">
            ...
            <Select
              ...
              onChange={(val) =>
                setFormData({ ...formData, supplierId: val ? (val as string) : undefined })
              }
              searchable
              placeholder={
                isLoadingSuppliers
            ...
            <p className="text-xs text-slate-500 mt-1.5">
              Le bénéficiaire doit exister dans la liste des fournisseurs. Pour ajouter un nouveau
              bénéficiaire, créez-le d'abord depuis le module Fournisseurs.
            </p>
          </Section>
