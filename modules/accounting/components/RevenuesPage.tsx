...
export const RevenuesPage: React.FC = () => {
  const { filteredTransactions, prevFilteredTransactions } =
...
const StaffServiceTable: React.FC<{ data: StaffServiceRow[]; totalRevenue: number }> = ({
  data,
  totalRevenue,
}) => {
