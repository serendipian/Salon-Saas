        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <div className="relative">
              ...
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-slate-400">unités</span>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">Affiche les colonnes Coût et Marge dans la vue tableau des produits</p>
            </div>
            <button
              type="button"
              role="switch"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500">Mode d'affichage par défaut de la liste des produits</p>
            </div>
