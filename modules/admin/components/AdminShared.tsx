...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-[16px] font-semibold mb-2" style={{ color: '#1a1f36' }}>
          {title}
        </h3>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = danger ? '#c0152f' : '#5850ec';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = danger ? '#df1b41' : '#635bff';
            }}
          >
            {confirmLabel}
          </button>
