          ...
          <Section title="Rôle & Statut">
            ...
            <Select
              ...
              onChange={(val) => {
                ...
                setFormData({ ...formData, role: val as StaffMember['role'] });
              }}
              error={errors.role}
              options={[
          ...
          <Section title="Contrat & Rémunération">
            <div className="space-y-4">
              <Select
                ...
                onChange={(val) =>
                  setFormData({ ...formData, contractType: val as StaffMember['contractType'] })
                }
                options={[
                  { value: 'CDI', label: 'CDI' },
                  { value: 'CDD', label: 'CDD' },
              ...
              <div className="grid grid-cols-2 gap-3">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, weeklyHours: parseFloat(e.target.value) })
                  }
                />
                <Input
                  label="Commission (%)"
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      commissionRate: Math.min(100, Math.max(0, parseFloat(e.target.value) || 0)),
                    })
                  }
