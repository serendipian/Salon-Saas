        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Section
            ...
            action={
              <button
                onClick={addVariant}
                className="text-xs font-medium text-slate-700 hover:bg-slate-100 border border-slate-200 px-2 py-1 rounded transition-colors shadow-sm"
              >
                + Ajouter
              </button>
            }
          >
            <div className="space-y-3">
              {formData.variants.map((variant) => (
                <div
                  key={variant.id}
                  className="flex items-start gap-3 p-3 rounded-lg bg-slate-50 border border-slate-200/60"
                >
                  <div className="flex-1 grid grid-cols-12 gap-3">
                    ...
                    <div className="col-span-2">
                      <Input
                        ...
                        value={variant.cost}
                        onChange={(e) =>
                          updateVariant(variant.id, 'cost', parseFloat(e.target.value) || 0)
                        }
                      />
                    </div>
                    <div className="col-span-2">
                  ...
                  {formData.variants.length > 1 && (
                    <button
                      ...
                      className="mt-6 text-slate-400 hover:text-red-600 transition-colors"
                    >
                      <Trash2 size={16} />
                    </button>
                  )}
