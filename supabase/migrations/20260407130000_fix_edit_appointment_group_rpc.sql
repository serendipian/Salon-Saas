-- Fix: correct variable assignment in edit_appointment_group RPC
-- and add explicit UUID casts for JSONB-extracted values.
...
BEGIN
  ...
  SELECT group_id, salon_id INTO v_old_group_id, v_old_salon_id
  ...
  LOOP
    INSERT INTO appointments (
      ...
      v_new_group_id,
      p_client_id,
      NULLIF(v_block->>'service_id', '')::uuid,
      NULLIF(v_block->>'service_variant_id', '')::uuid,
      NULLIF(v_block->>'staff_id', '')::uuid,
